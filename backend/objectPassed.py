...
def objectPassed(last_positions, positions, screen_dimensions, line_position=50, debug_level=0):
    '''
...
for tc in test_cases:
    result = objectPassed(tc[0], tc[1], [10, 10], debug_level=4)  # debug_level=2
    # print(f"\nran test case, got:\n{result}")
